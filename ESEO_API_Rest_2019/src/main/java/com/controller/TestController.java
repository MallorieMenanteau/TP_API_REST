...
public class TestController {
	...
	@ResponseBody
	public String getbdd(@RequestParam(required=false,value="value") String value) {
		System.out.println("Appel GET");
	...
	@ResponseBody
	public String getbddByCodePostal(@RequestParam(required=false,value="codePostal") String value) {
		System.out.println("Appel GET");
		VilleFranceDAO dao = new VilleFranceDAO();
